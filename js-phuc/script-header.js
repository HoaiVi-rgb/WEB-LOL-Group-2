...
const promoData = {
    "lol": { img: "./asset-hau/img/lol-header.png" },
    "valorant": { img: "./asset-hau/img/vlr.png" },
    "tft": { img: "./asset-hau/img/tft.png" },
    "arcane": { img: "./asset-hau/img/arcane.png" },
    "wr": { img: "./asset-hau/img/wild-rift.png" },
    "lor": { img: "./asset-hau/img/runeterra.png" },
    "ruinedking": { img: "./asset-hau/img/ruined-king.png" },
    "convergence": { img: "./asset-hau/img/convergence.png" },
    "songofnunu": { img: "./asset-hau/img/songofnunu.png" },
    "riotforge": { img: "./asset-hau/img/riot-forge.png" },
    "lolesports": { img: "./asset-hau/img/lol-esport.png" },
    "valesports": { img: "./asset-hau/img/vlr-esport.png" },
    "universe": { img: "./asset-hau/img/vutru.png" },
    "music": { img: "./asset-hau/img/riot-music.png" },
    "riotgames": { img: "./asset-hau/img/riotgames.png" },
    "riotsupport": { img: "./asset-hau/img/riot-sp.png" }
};
